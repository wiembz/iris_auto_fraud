"""
etl/staging_area/load_clients_sa.py
=====================================
Charge enriched_clients.xlsx -> staging.stg_clients.

Usage autonome :
  python etl/staging_area/load_clients_sa.py
"""
...
SOURCE_FILE = "enriched_clients.xlsx"
SCHEMA      = "staging"
...
def load_clients_sa(
    ...
    """
    Lit enriched_clients.xlsx, ajoute les colonnes techniques,
    charge staging.stg_clients, ecrit une ligne d'audit.
...
if __name__ == "__main__":
    ...
    _logger = sa_utils.setup_logging(_run_id, log_name="load_clients_sa")
    _engine = sa_utils.build_engine(_logger)
    sa_utils.create_schemas(_engine, _logger)
    _n = load_clients_sa(_run_id, _engine, _logger)
